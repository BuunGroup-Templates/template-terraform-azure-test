...
```hcl
module "template-terraform-azure-test" {
  source = "github.com/BuunGroup-Templates/template-terraform-azure-test?ref=v1.0.0" // Replace with correct source and version
